      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="bg-[#09090b] border border-[#27272a] cyber-button p-8 relative overflow-hidden flex flex-col items-center text-center">
          ...
          <div className="space-y-6 relative z-10 w-full max-w-xl mx-auto">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-white tracking-widest uppercase mb-2">{displayProfile.name}</h1>
              <div className="text-[#a1a1aa] text-lg">@{displayProfile.screen_name}</div>
            </div>
            
            <div className="flex flex-wrap gap-3 justify-center">
              <span className="px-4 py-1.5 text-sm font-bold uppercase tracking-wider border" style={{ backgroundColor: `${displayProfile.tierColor}15`, color: displayProfile.tierColor, borderColor: `${displayProfile.tierColor}50` }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-2 mt-8 pt-6 border-t border-[#27272a]">
              ...
              <div className="bg-[#050505] border border-[#18181b] p-3 rounded-lg">
                <div className="text-[#71717a] text-[10px] uppercase mb-1 flex items-center justify-center"><User className="w-3 h-3 mr-1" /> Network Status</div>
                <div className="text-white font-bold">VERIFIED ON-CHAIN</div>
              </div>
            </div>
        ...
        <div className="bg-[#09090b] border border-[#27272a] cyber-button p-6 relative">
          <h2 className="text-[#836EF9] text-sm font-bold tracking-widest uppercase mb-6 flex items-center">
            <Crosshair className="w-4 h-4 mr-2" /> {isOwnProfile ? 'Your_Card_Market' : `${displayProfile.screen_name}'s Market`}
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center py-2 border-b border-[#18181b]">
                ...
                <span className="text-[#4ade80] text-sm font-bold">{Number((displayData as any)[2] || 0)}</span>
              </div>
            </div>
